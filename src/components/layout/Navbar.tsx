...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 h-16 flex items-center justify-around bg-background/90 backdrop-blur-xl border-t border-border">
        {[
